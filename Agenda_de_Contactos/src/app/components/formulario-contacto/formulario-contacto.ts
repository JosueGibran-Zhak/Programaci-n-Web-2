...
//Importación para usar el mat-select en el formulario
    ...
    <mat-card class="section-card">
      <mat-card-content>
        ...
        <form class="form-grid" (ngSubmit)="guardar()">
          ...
          <!--Seleccion de categoria usando Angular Materials-->
          <mat-form-field appearance="outline">
            <mat-label>Categoría</mat-label>

            <!--El valor del imput viene de categoria-->
            <mat-select
              [(ngModel)]= "categoria" 
              name = 'categoria'
              required
            >
            <!--El @for recorre categorias y por cada elemento crea un mat-option (una opción para seleccionar)-->
              @for (categoria of categorias; track categoria) {
                <!--El valor interno de categoria es una string-->
...
export class FormularioContactoComponent {
  ...
  //Formulario constituido por 3 parametros
  nombre = '';
  telefono = '';
  correo = '';
  //Declaro categoria tipo Categoria con valor "familia" (valor por defecto)
  categoria: Categoria= Categoria.familia;
  
  //variable para obtener los posibles valores.
  ...
  private limpiarFormulario(): void {
    ...
    this.telefono = '';
    this.correo = '';
    this.categoria = Categoria.familia;
  }
}